 ...
 */
public final class UIComponentPrompts {

    private UIComponentPrompts() {
    ...
    public static final String SYSTEM_PROMPT = """
            You are an AI assistant that responds with structured UI components instead of plain text.
